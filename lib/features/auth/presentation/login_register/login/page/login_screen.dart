        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Gap(15),
              CustomPassField(hintText: 'Enter your password'),
              Gap(10),
              Row(
              ...
              SignInMethod(text: 'Sign in with Google', asset: AppAssets.google),
              Gap(15),
              SignInMethod(text: 'Sign in with Apple', asset: AppAssets.apple),
            ],
          ),
        ),
      ),
